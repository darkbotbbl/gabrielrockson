    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.core.fields.StreamField([('title', streams.blocks.TitleBlock()), ('normal_text', streams.blocks.NormalTextBlock()), ('main_text', streams.blocks.FullRichTextFieldBlock())])),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='snippets.blogauthor')),
